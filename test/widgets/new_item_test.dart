...
void main() {
  group('NewItem Widget Tests', () {
    ...
    testWidgets('should show validation error for non-numeric quantity', (WidgetTester tester) async {
      // Arrange
      await tester.pumpWidget(const MaterialApp(home: NewItem()));
    ...
    testWidgets('should have default quantity of 1', (WidgetTester tester) async {
      // Arrange & Act
      await tester.pumpWidget(const MaterialApp(home: NewItem()));
    ...
    testWidgets('should display all category options in dropdown', (WidgetTester tester) async {
      // Arrange
      await tester.pumpWidget(const MaterialApp(home: NewItem()));
    ...
    testWidgets('should change selected category when dropdown option is tapped', (WidgetTester tester) async {
      // Arrange
      await tester.pumpWidget(const MaterialApp(home: NewItem()));
    ...
    testWidgets('should reset form when reset button is tapped', (WidgetTester tester) async {
      // Arrange
      await tester.pumpWidget(const MaterialApp(home: NewItem()));
    ...
    testWidgets('should return GroceryItem when valid form is submitted', (WidgetTester tester) async {
      // Arrange
    ...
    testWidgets('should return null when back button is pressed', (WidgetTester tester) async {
      // Arrange
      GroceryItem? returnedItem;
    ...
    testWidgets('should display category colors in dropdown options', (WidgetTester tester) async {
      // Arrange
      await tester.pumpWidget(const MaterialApp(home: NewItem()));
    ...
    testWidgets('should have proper keyboard type for quantity field', (WidgetTester tester) async {
      // Arrange & Act
      await tester.pumpWidget(const MaterialApp(home: NewItem()));
    ...
    testWidgets('should limit name field to 50 characters', (WidgetTester tester) async {
      // Arrange & Act
      await tester.pumpWidget(const MaterialApp(home: NewItem()));
      ...
      await tester.enterText(find.byType(TextFormField).last, '1'); // Add quantity
      await tester.tap(find.text('Add Item'));
      await tester.pumpAndSettle();
      
      // Should not show validation error for exactly 50 characters
      expect(find.text('Must be between 1 and 50 characters long.'), findsNothing);
    });
  });
}